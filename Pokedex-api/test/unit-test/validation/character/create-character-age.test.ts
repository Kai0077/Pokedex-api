...
describe("CreateCharacterDTO – Age partition (A23–A33)", () => {
  it.each([
    ...
    {
      label: "A26: Age = 13 (lower boundary)",
      overrides: { age: 13 },
      valid: true,
    },
    { label: "A27: Age = 14", overrides: { age: 14 }, valid: true },
    { label: "A28: Age = 55 (mid-range)", overrides: { age: 55 }, valid: true },
    { label: "A29: Age = 75 (13–110)", overrides: { age: 75 }, valid: true },
    { label: "A30: Age = 109", overrides: { age: 109 }, valid: true },
    {
      label: "A31: Age = 110 (upper boundary)",
      overrides: { age: 110 },
      valid: true,
    },
